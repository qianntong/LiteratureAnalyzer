...
if __name__ == "__main__":
    import os
    # query = "multimodal terminal reduce delay"
    # query = "digital twins intermodal terminal literature review"
    query = "terminal resource allocation railway"
    path = os.getcwd()
##    path = os.path.join(path, 'output')
...
if __name__ == '__main__':
    # title = 'multimodal container terminal reduce delay'
    title = "terminal resource allocation railway"
    # title = "container management"
    path = 'C:\\Users\\Irena Tong\\PycharmProjects\\LitReviewer-main\\literature-review'
    gs = gScholar(title, startyear=2012, num=500)
    url = gs.makeQuery()
    print(url)
    links = gs.getLinks(url)
